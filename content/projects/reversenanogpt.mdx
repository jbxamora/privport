---
title: reversenanogpt
description: A minimal character-level language model using Transformer architecture in PyTorch
date: "2021-05-02"
repository: jbxamora/reversenanogpt
published: true
---
...
You can also view the 1000th step iteration in the `1000thstep.txt`
