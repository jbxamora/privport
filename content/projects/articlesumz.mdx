---
title: "@jbxamora/articlesumz"
description: Sumz is an open-source article summarization tool powered by the advanced capabilities of OpenAI GPT-4. Designed to help users quickly grasp the essence of lengthy articles, Sumz transforms verbose content into clear, concise, and informative summaries
repository: jbxamora/articlesumz
date: "2023-4-13"
published: true
...
### RDTK Config
Here's How I configured the request using RDTK
```js
